            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-start flex-grow-1 pe-3">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark">
                    <li>
                      <Link className="dropdown-item" to="/addsalary">
                        Add Salary
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link className="dropdown-item" to="/managesalary">
                        Manage Salary
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark">
                    <li>
                      <Link className="dropdown-item" to="/Applyleave">
                        Apply Leave
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link className="dropdown-item" to="/leavehistory">
                        My Leave History
                      </Link>
                    </li>
                  </ul>
